...
class ArgsNameTest {
    ...
    void whenWrongSomeArgument() {
        assertThatThrownBy(() -> ArgsName.of(new String[] {})).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    @Test
    void whenNotEqually() {
        assertThatThrownBy(() -> ArgsName.of(new String[] {"-Xmx512"})).isInstanceOf(IllegalArgumentException.class);
    }
